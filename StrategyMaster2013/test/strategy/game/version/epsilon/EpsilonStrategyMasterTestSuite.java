 ...
 * @version Sep 12, 2013
 */
public class EpsilonStrategyMasterTestSuite
{
	...
	private final static MockEpsilonGameFactory mockFactory = MockEpsilonGameFactory.getInstance();
	private StrategyGameController game;	// used for many tests
	private MockEpsilonStrategyGameController mockGame;
	private MockEpsilonStrategyGameController mockObsvGame;
	final List<StrategyGameObserver> reporterList = new ArrayList<StrategyGameObserver>();
	final MockStrategyGameReporter reporter = new MockStrategyGameReporter();
	...
	public void setup() throws StrategyException
	{
		...
		addToConfiguration(FLAG, RED, 9, 0);
...
//		addToConfiguration(MINER, BLUE, 0, 9);
		addToConfiguration(FLAG, BLUE, 0, 9);
		...
		game = factory.makeEpsilonStrategyGame(redConfiguration, blueConfiguration);
		game.startGame();
		mockGame = mockFactory.makeMockEpsilonStrategyGame(redConfiguration, blueConfiguration);
		mockGame.startGame();
		
		reporterList.add(reporter);
		mockObsvGame = mockFactory.makeMockEpsilonStrategyGame(redConfiguration, blueConfiguration,reporterList);
		mockObsvGame.startGame();
	}
	
	@Test(expected=StrategyException.class)
	public void cannotCreateStrategyWithNullConfigurations() throws StrategyException
	{
		factory.makeEpsilonStrategyGame(null, null);
	}
	
	@Test
	public void createStrategyController() throws StrategyException
	{
		assertNotNull(factory.makeEpsilonStrategyGame(redConfiguration, blueConfiguration));
	}
	...
	public void redConfigurationHasTooFewItem() throws StrategyException
	{
		...
		factory.makeEpsilonStrategyGame(redConfiguration, blueConfiguration);
	}
	...
	public void attemptToMoveAfterGameIsOver() throws StrategyException
	{
		...
		addToMockConfiguration(FLAG, BLUE, 1, 4);
		addToMockConfiguration(MARSHAL, BLUE, 9, 9);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(SCOUT, loc12, loc13);
		mockGame.move(MARSHAL, loc99, loc98);
		mockGame.move(SCOUT, loc13, loc14);
		mockGame.move(MARSHAL, loc98, loc99);
	} 
	...
	{
		addToMockConfiguration(CAPTAIN, RED, 1, 2);
		addToMockConfiguration(FLAG, BLUE, 1, 3);
		addToMockConfiguration(FLAG, BLUE, 1, 4);
		addToMockConfiguration(MARSHAL, BLUE, 9, 9);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(CAPTAIN, loc12, loc13);
		mockGame.move(MARSHAL, loc99, loc98);
		final MoveResult moveResult = mockGame.move(CAPTAIN, loc13, loc14);
	...
	public void blueWins() throws StrategyException
	{
		...
		addToMockConfiguration(FLAG, RED, 1, 2);
		addToMockConfiguration(MARSHAL, BLUE, 1, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(SCOUT, loc99, loc98);
		mockGame.move(MARSHAL, loc14, loc13);
		mockGame.move(SCOUT, loc98, loc99);
	...
	@Test
	public void FirstLieutenantStrikeFromDistanceAndWins() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 1, 3);
		addToMockConfiguration(SCOUT, BLUE, 1, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		final MoveResult moveResult = mockGame.move(FIRST_LIEUTENANT, loc11, loc13);
		assertEquals(OK,moveResult.getStatus());
		assertEquals(
				new PieceLocationDescriptor(new Piece(FIRST_LIEUTENANT, RED), loc13),
				moveResult.getBattleWinner());
		assertNull(mockGame.getPieceAt(loc11));
		assertEquals(new Piece(FIRST_LIEUTENANT, RED), mockGame.getPieceAt(loc13));
	}
	
	@Test
	public void FirstLieutenantStrikeFromDistanceAndLoses() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(MARSHAL, BLUE, 1, 3);
		addToMockConfiguration(SCOUT, RED, 1, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		final MoveResult moveResult = mockGame.move(FIRST_LIEUTENANT, loc11, loc13);
		assertEquals(OK,moveResult.getStatus());
		assertEquals(
				new PieceLocationDescriptor(new Piece(MARSHAL, BLUE), loc13),
				moveResult.getBattleWinner());
		assertNull(mockGame.getPieceAt(loc11));
		assertEquals(new Piece(MARSHAL, BLUE), mockGame.getPieceAt(loc13));
	}
	
	@Test
	public void FirstLieutenantStrikeAndWins() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 1, 2);
		addToMockConfiguration(SCOUT, BLUE, 1, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		final MoveResult moveResult = mockGame.move(FIRST_LIEUTENANT, loc11, loc12);
		assertEquals(OK,moveResult.getStatus());
		assertEquals(
				new PieceLocationDescriptor(new Piece(FIRST_LIEUTENANT, RED), loc12),
				moveResult.getBattleWinner());
		assertNull(mockGame.getPieceAt(loc11));
		assertEquals(new Piece(FIRST_LIEUTENANT, RED), mockGame.getPieceAt(loc12));
	}
	
	@Test
	public void FirstLieutenantStrikeAndLoses() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(MARSHAL, BLUE, 1, 2);
		addToMockConfiguration(SCOUT, RED, 1, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		final MoveResult moveResult = mockGame.move(FIRST_LIEUTENANT, loc11, loc12);
		assertEquals(OK,moveResult.getStatus());
		assertEquals(
				new PieceLocationDescriptor(new Piece(MARSHAL, BLUE), loc11),
				moveResult.getBattleWinner());
		assertNull(mockGame.getPieceAt(loc12));
		assertEquals(new Piece(MARSHAL, BLUE), mockGame.getPieceAt(loc11));
	}
	
	@Test(expected=StrategyException.class)
	public void FirstLieutenantCannotMove2UnlessAttacking() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 5, 1);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(FIRST_LIEUTENANT, loc11, loc13);
	}
	
	@Test(expected=StrategyException.class)
	public void FirstLieutenantCannotMoveMoreThan2() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 9, 9);
		addToMockConfiguration(SCOUT, BLUE, 5, 1);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(FIRST_LIEUTENANT, loc99, loc96);
	}
	
	@Test(expected=StrategyException.class)
	public void FirstLieutenantCannotJumpAndAttack() throws StrategyException
	{
		addToMockConfiguration(FIRST_LIEUTENANT, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 1, 3);
		addToMockConfiguration(SCOUT, RED, 1, 2);
	...
	@Test
	public void testRedResignBlueWin() throws StrategyException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 5, 5);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(MARSHAL, loc11, loc12); //red moves
		mockGame.move(SCOUT, loc55, loc56); //blue moves
		final MoveResult result = mockGame.move(null,null,null); //red resigns
		assertEquals(BLUE_WINS,result.getStatus());
	}
	
	@Test
	public void testBlueesignRedWin() throws StrategyException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		addToMockConfiguration(SCOUT, BLUE, 5, 5);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockGame.move(MARSHAL, loc11, loc12); //red moves
		final MoveResult result = mockGame.move(null,null,null); //blue resigns
		assertEquals(RED_WINS,result.getStatus());
	}
	
	@Test
	public void defeatingOneFlagIsOK() throws StrategyException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		addToMockConfiguration(FLAG, BLUE, 1, 2);
		addToMockConfiguration(SCOUT, BLUE, 5, 4);
		mockGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		final MoveResult result = mockGame.move(MARSHAL, loc11, loc12);
		assertEquals(FLAG_CAPTURED,result.getStatus());
	}
	
	@Test
	public void testReporterGameStart() throws StrategyException, IOException
	{
		assertEquals("Game Started",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterRedWins() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc11,loc12);
		assertEquals("Red wins!",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterBlueWins() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, RED, 9, 9);
		addToMockConfiguration(MARSHAL, BLUE, 1, 1);
		addToMockConfiguration(FLAG, RED, 1, 2);
		addToMockConfiguration(FLAG, RED, 1, 3);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc99,loc98);
		mockObsvGame.move(MARSHAL,loc11,loc12);
		mockObsvGame.move(MARSHAL,loc98,loc99);
		mockObsvGame.move(MARSHAL,loc12,loc13);
		assertEquals("Blue wins!",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterDraw() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		addToMockConfiguration(MARSHAL, BLUE, 1, 2);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc11,loc12);
		assertEquals("Its a draw!",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterBlueFlagCaptured() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, RED, 1, 1);
		addToMockConfiguration(FLAG, BLUE, 1, 2);
		addToMockConfiguration(MARSHAL, BLUE, 1, 4);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc11,loc12);
		assertEquals("Red captured the first of blue's flags at (1,2)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterRedFlagCaptured() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, BLUE, 1, 2);
		addToMockConfiguration(FLAG, RED, 1, 3);
		addToMockConfiguration(MARSHAL, RED, 1, 4);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc14,loc15);
		mockObsvGame.move(MARSHAL,loc12,loc13);
		assertEquals("Blue captured the first of red's flags at (1,3)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterValidBlueMove() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, BLUE, 2, 2);
		addToMockConfiguration(MARSHAL, RED, 1, 4);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc14,loc13);
		mockObsvGame.move(MARSHAL,loc22,loc12);
		assertEquals("Blue moved successfully to (1,2)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterValidRedMove() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, BLUE, 2, 2);
		addToMockConfiguration(MARSHAL, RED, 1, 4);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc14,loc13);
		assertEquals("Red moved successfully to (1,3)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterBlueKillsRedPiece() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, BLUE, 2, 2);
		addToMockConfiguration(CAPTAIN, RED, 1, 2);
		addToMockConfiguration(CAPTAIN, RED, 9, 9);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(CAPTAIN, loc99, loc98);
		mockObsvGame.move(MARSHAL,loc22,loc12);
		assertEquals("Blue moved successfully to (1,2)",reporter.getOutContentString());
		System.setOut(null);
	}
	...
	@Test
	public void reporterRedKillsBluePiece() throws StrategyException, IOException
	{
		addToMockConfiguration(CAPTAIN, BLUE, 9, 8);
		addToMockConfiguration(CAPTAIN, BLUE, 1, 2);
		addToMockConfiguration(MARSHAL, RED, 9, 9);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL, loc99, loc98);
		assertEquals("Red moved successfully to (9,8)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterBothPiecesDied() throws StrategyException, IOException
	{
		addToMockConfiguration(MARSHAL, BLUE, 2, 2);
		addToMockConfiguration(MARSHAL, RED, 1, 2);
		addToMockConfiguration(CAPTAIN, RED, 2, 3);
		addToMockConfiguration(CAPTAIN, BLUE, 3, 3);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(MARSHAL,loc12,loc22);
		assertEquals("Both Marshal pieces died in combat at (2,2)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterBlueDiedOnRedPiece() throws StrategyException, IOException
	{
		addToMockConfiguration(CAPTAIN, BLUE, 2, 2);
		addToMockConfiguration(CAPTAIN, BLUE, 2, 3);
		addToMockConfiguration(MARSHAL, RED, 1, 2);
		addToMockConfiguration(CAPTAIN, RED, 9, 9);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(CAPTAIN,loc99,loc98);
		mockObsvGame.move(CAPTAIN,loc22,loc12);
		assertEquals("Blue Lost piece Captain in battle to at (1,2)",reporter.getOutContentString());
		System.setOut(null);
	}
	
	@Test
	public void reporterRedDiedOnBluePiece() throws StrategyException, IOException
	{
		addToMockConfiguration(CAPTAIN, BLUE, 2, 2);
		addToMockConfiguration(CAPTAIN, RED, 2, 3);
		addToMockConfiguration(MARSHAL, BLUE, 9, 8);
		addToMockConfiguration(SCOUT, RED, 9, 9);
		mockObsvGame.setConfigurations(redMockConfiguration, blueMockConfiguration);
		mockObsvGame.move(SCOUT,loc99,loc98);
		assertEquals("Red Lost piece Scout in battle to at (9,8)",reporter.getOutContentString());
		System.setOut(null);
	}
	...
	public MockStrategyGameReporter setUpObserverGame() throws StrategyException
	{
		final List<StrategyGameObserver> reporterList = new ArrayList<StrategyGameObserver>();
		final MockStrategyGameReporter reporter = new MockStrategyGameReporter();
		reporterList.add(reporter);
		mockGame = mockFactory.makeMockEpsilonStrategyGame(redConfiguration, blueConfiguration,reporterList);
		mockGame.startGame();
		return reporter;
	}
}
