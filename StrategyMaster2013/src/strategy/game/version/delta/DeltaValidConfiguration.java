 ...
 * @version gamma
 */
public class DeltaValidConfiguration implements StrategyValidConfiguration{
	 ...
	 * @param board
	 */
	public DeltaValidConfiguration(Collection <PieceLocationDescriptor> blueConfiguration, 
