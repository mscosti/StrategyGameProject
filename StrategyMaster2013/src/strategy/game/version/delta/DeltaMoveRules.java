 ...
 * @version gamma
 */
public class DeltaMoveRules implements StrategyMoveRules {
	 ...
	 */
	public DeltaMoveRules(Board board, PieceLocationDescriptor fromPiece, Location to, 
	...
	public void checkScoutMove() throws StrategyException 
	{
		...
		if (from_x < to_x)
		{
			for (int i = from_x + 1; i < to_x; i++)
			{
				...
				{
					throw new StrategyException("Scout can not jump over pieces!");
				}
			}
		}
		else if (from_x > to_x)
